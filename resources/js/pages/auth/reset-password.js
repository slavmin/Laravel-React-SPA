...
export default function ResetPassword() {
  ...
  return (
    <div className="flex justify-center items-center w-full py-4 flex-col min-h-screen bg-gray-200">
        ...
        <div className="bg-white border-l-4 border-blue text-sm text-grey-darker p-4 mb-4 w-3/4 sm:w-1/2 lg:w-2/5 xl:w-1/3" role="alert">
          <p>
            ...
            <span className="pl-2">
              {' '}
              Please
              <Link to="/login" className="no-underline text-grey-darker font-bold">
                {' '}
                login
                {' '}
              </Link>
      ...
      <form onSubmit={handleSubmit} method="POST" className="border rounded bg-white border-grey-light w-3/4 sm:w-1/2 lg:w-2/5 xl:w-1/3 px-8 py-4">
        ...
        <div className="mb-4">
          <label className="block text-grey-darker text-sm font-bold mb-2" htmlFor="password-confirmation">
            {' '}
        ...
        <div className="mt-6 mb-2">
          <button type="submit" className="border rounded-full p-3 text-white bg-indigo-500 w-full font-bold hover:bg-indigo-500-dark">
            Reset
          </button>
        </div>
      </form>
